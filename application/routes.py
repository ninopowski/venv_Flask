...
data_json = [{"courseID":"1111","title":"PHP 101","description":"Intro to PHP","credits":3,"term":"Fall, Spring"},
...
def courses(term="2020"):
    return render_template("courses.html", data=data_json, courses=True, term=term)
